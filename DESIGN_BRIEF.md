...
**Exhbt** — Electron desktop app สำหรับ photographer และ creative
...
### ชื่อและการแสดงผล
- **ชื่อ:** `EXHBT` — ตัวพิมพ์ใหญ่ทั้งหมดเสมอ ไม่มีข้อยกเว้น
- **อ่านว่า:** "เอ็กซ์-บิต" (exhibit)
- **Tagline:** "Your portfolio. Free forever." — ใช้ใน Onboarding screen เท่านั้น
- **Logo:** ใช้ text `EXHBT` เป็น logotype — ไม่มี icon แยก ตัวอักษรคือ identity
...
States:
- **Login screen** — logotype EXHBT, tagline, ปุ่ม "Login with GitHub", link "สมัคร GitHub ฟรี" เล็กๆ ด้านล่าง
...
│   240px     │    flex: 1           │   ~420px            │
│             │                      │                      │
│  EXHBT  ⚙  │  [Album title input] │  [webview]          │
│             │                      │                      │
│             │  [date] [desc]       │                      │
│ • Home      │                      │                      │
...
**Sidebar:**
- Titlebar drag region บนสุด (38px) — `EXHBT` logotype ซ้าย + settings icon ขวา
